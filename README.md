...
(a) Key2 can spend the money after a timelock -- allowing for an "unvaulting tx" that sends the money wherever you want
(b) Key1 and Key2 can (together) spend the money immediately -- this allows for a "revaulting tx" (tx2) explained below
